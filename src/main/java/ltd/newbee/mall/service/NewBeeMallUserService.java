...
public interface NewBeeMallUserService {
     ...
     * @return
     */
    BigDecimal findUserWalletValue(Long userId);

    /**
     *
     * @param userId
     * @param userRechargeId
     * @param userRechargeValue
     * @return
     */
    UserWalletFindVO confirmUserRecharge(Long userId, String userRechargeId, BigDecimal userRechargeValue);
}
