...
import ltd.newbee.mall.dao.GlobalConfigMapper;
import ltd.newbee.mall.dao.IndexConfigMapper;
import ltd.newbee.mall.dao.NewBeeMallGoodsMapper;
import ltd.newbee.mall.entity.GlobalConfig;
...
public class NewBeeMallIndexConfigServiceImpl implements NewBeeMallIndexConfigService {
    ...
    public GlobalConfig getGlobalConfig(){
        return globalConfigMapper.selectConfig(1);
    }

    public int setGlobalConfig(GlobalConfigParam globalConfigParam){
        GlobalConfig globalConfig = new GlobalConfig();
        globalConfig.setConfigId(1);
        globalConfig.setApiList(globalConfigParam.getApiList());
        globalConfig.setExchangeConfig(globalConfigParam.getExchange());
        globalConfig.setConvertConfig(globalConfigParam.getConvert());
        return globalConfigMapper.updateConfig(globalConfig);
    }
