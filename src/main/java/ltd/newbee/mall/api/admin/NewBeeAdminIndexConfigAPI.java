...
import ltd.newbee.mall.api.admin.param.GlobalConfigParam;
...
public class NewBeeAdminIndexConfigAPI {
    ...
    @Resource
    private NewBeeMallIndexConfigServiceImpl newBeeMallIndexConfigService;

    @RequestMapping(value = "/convertConfigs", method = RequestMethod.POST)
    @ApiOperation(value = "设置全局配置参数", notes = "设置全局配置参数")
    public Result convert(@RequestBody GlobalConfigParam globalConfigParam, @TokenToAdminUser AdminUserToken adminUser) {
        logger.info("adminUser:{}", adminUser.toString());
        return ResultGenerator.genSuccessResult(newBeeMallIndexConfigService.setGlobalConfig(globalConfigParam));
    }

    @RequestMapping(value = "/convertConfigs", method = RequestMethod.GET)
    @ApiOperation(value = "获取全局配置参数", notes = "获取全局配置参数")
    public Result getConvert(@TokenToAdminUser AdminUserToken adminUser) {
        logger.info("adminUser:{}", adminUser.toString());
        return ResultGenerator.genSuccessResult(newBeeMallIndexConfigService.getGlobalConfig());
    }
