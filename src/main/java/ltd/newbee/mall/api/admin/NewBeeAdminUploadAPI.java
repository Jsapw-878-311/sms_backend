...
public class NewBeeAdminUploadAPI {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam(value = "file", required = false) MultipartFile file, @TokenToAdminUser AdminUserToken adminUser) throws URISyntaxException {
    ...
    @RequestMapping(value = "/upload/fila", method = RequestMethod.POST)
    @ApiOperation(value = "单图上传", notes = "file Name \"fila\"")
    public String upload(MultipartFile file) {
        String fileName = file.getOriginalFilename();
        String relativePath = "";
        try {
            relativePath = "/file/image/"+ fileName;
            String webPath = Constants.FILE_UPLOAD_DIC;
