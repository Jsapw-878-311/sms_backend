...
public class NewBeeMallUserAddressAPI {
    ...
    @Resource
    private NewBeeMallUserAddressServiceImpl mallUserAddressService;
...
//    }
    ...
    public Result<List<NewBeeMallUserAddressVO>> addressList() {
        Long aaa = 6L;
        return ResultGenerator.genSuccessResult(mallUserAddressService.getMyAddresses(aaa));
    }
...
//        返回写操作结果
    ...
    public Result<SaveMallUserAddressParam> testtest(@RequestBody SaveMallUserAddressParam saveMallUserAddressParam){
        MallUserAddress userAddress = new MallUserAddress();
        BeanUtil.copyProperties(saveMallUserAddressParam, userAddress);
